...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Publications",
          description: "Collection of my publications, conference papers, and my M.Sc. theses (at the bottom of the page). You can browse abstracts and read the full papers via interactive buttons under each entry. Feel free to Download any material, if you find it valuable, but please remember to cite each work (e.g., using BIB button). If you have any questions or wish to discuss further, I’d be happy to hear from you!",
          section: "Navigation",
          handler: () => {
          ...
          title: "CV",
          description: "My personal Curriculum Vitae. Feel free to download a PDF version and reach out!",
          section: "Navigation",
          handler: () => {
          ...
          title: "Teaching",
          description: "Here you’ll find materials from the courses and lectures I have given. If you have any questions or would like to explore any of the topics further, don’t hesitate to reach out!",
          section: "Navigation",
          handler: () => {
